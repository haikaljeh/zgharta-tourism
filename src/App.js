...
export default function ZghartaTourismApp() {
  ...
  const catIconPaths = {
    ...
    nature: { vb: '0 0 24 24', d: '<path d="m17 14 3 3.3a1 1 0 0 1-.7 1.7H4.7a1 1 0 0 1-.7-1.7L7 14h-.3a1 1 0 0 1-.7-1.7L9 9h-.2A1 1 0 0 1 8 7.3L12 3l4 4.3a1 1 0 0 1-.8 1.7H15l3 3.3a1 1 0 0 1-.7 1.7H17Z"/><path d="M12 22v-3"/>' },
    heritage: { vb: '0 0 24 24', d: '<path d="M11.12 2.198a2 2 0 0 1 1.76.006l7.866 3.847c.476.233.31.949-.22.949H3.474c-.53 0-.695-.716-.22-.949z"/><path d="M6 7v11"/><path d="M10 7v11"/><path d="M14 7v11"/><path d="M18 7v11"/><line x1="3" y1="22" x2="21" y2="22"/>' },
    ...
    hotel: { vb: '0 0 24 24', d: '<path d="M2 20v-8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8"/><path d="M4 10V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4"/><path d="M12 4v6"/><line x1="2" y1="18" x2="22" y2="18"/>' },
    ...
    shop: { vb: '0 0 24 24', d: '<path d="M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z"/><path d="M16 10a4 4 0 0 1-8 0"/>' },
  };
  ...
  const MapScreen = () => <div className="map-screen" style={{ position: 'fixed', inset: 0, maxWidth: 448, margin: '0 auto', overflow: 'hidden', touchAction: 'none', zIndex: 1 }}>
    ...
    {/* Card carousel */}
    {visibleCards.length > 0 && <div ref={carouselRef} className="map-carousel" style={{ position: 'absolute', bottom: 72, left: 0, right: 0, zIndex: 10, display: 'flex', gap: 10, overflowX: 'auto', overflowY: 'visible', scrollSnapType: 'x mandatory', padding: '0 24px', WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', transform: cardsVisible ? 'translateY(0)' : 'translateY(calc(100% + 72px))', transition: 'transform 0.3s ease', pointerEvents: cardsVisible ? 'auto' : 'none' }}>
