...
export default function ZghartaTourismApp() {
  ...
  const MapScreen = () => {
    ...
    return <div className="map-screen" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Card carousel */}
      {visibleCards.length > 0 && <div ref={carouselRef} className="map-carousel" style={{ position: 'absolute', bottom: 58, left: 0, right: 0, zIndex: 10, display: 'flex', gap: 10, overflowX: 'auto', scrollSnapType: 'x mandatory', padding: '0 12px', WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none' }}>
